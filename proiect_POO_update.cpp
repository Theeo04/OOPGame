...
class villain : class villain {
    ...
    public:
	 	villain(string name, int health, int attack_points, int defense_points, string weapon1, string special_attack_name)
		{
            this->name = name;
            this->health = health;
            this->attack_points = attack_points;
		...
		void attack2(villain& attacker, Character& target, string weapon2)
        {
...
void decision(int tura, Character& Ch1, villain& V1) {
    int alegere;
    cout << "Choose your attack:" << endl;
    cin >> alegere;
    ...
    if (tura % 2 == 0) { // randul lui Ch1
        if (alegere == 1) // close attack
            Ch1.close_attack(Ch1, V1);
        if (alegere == 2)
            Ch1.far_attack(Ch1, V1);
        if (alegere == 3)
            Ch1.special_attack(Ch1, V1);
        if (alegere == 4)
        	Ch1.receive_health(Ch1);
    }
    else { // randul lui V1
        if (alegere == 1) // close attack
            V1.close_attack(V1, Ch1);
        if (alegere == 2)
            V1.far_attack(V1, Ch1);
        if (alegere == 3)
            V1.special_attack(V1, Ch1);
        if (alegere == 4)
        	V1.receive_health(V1);
    }
}
